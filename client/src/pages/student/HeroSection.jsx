  ...
  return (
    <div className='relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-20 px-4 text-center'>
      <div className="max-w-3xl mx-auto">
        <h1 className='text-white text-4xl font-bold mb-4 '>Find the Best Courses fro You</h1>
        ...
        <form onSubmit={searchHandler} className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto mb-6'>
          <Input
            ...
            className='flex-grow border-none focus-visible:ring-0 px-6 py-3 text-gray-900 dark:text-gray-100 placeholder:bg-gray-400 dark:placeholder-gray-500'
          />
          <Button type="submit" className='bg-blue-600 dark:bg-blue-700 text-white px-6 py-3 rounded-r-full hover:bg-blue-700 dark:bg-blue-800'>Search</Button>
        </form>
