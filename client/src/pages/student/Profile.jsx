  ...
  return (
    <div className='max-w-4xl mx-auto px-4 my-24'>
        ...
        <div>
          ...
          <div className='mb-2'>
            <h1 className='font-semibold text-gray-900 dark:text-gray-100'>
              Name:
              <span className='font-normal text-gray-700 dark:text-gray-300 ml-2'>Ashish patel</span>
            </h1>
          </div>
          ...
          <div className='mb-2'>
            <h1 className='font-semibold text-gray-900 dark:text-gray-100'>
              Email:
              <span className='font-normal text-gray-700 dark:text-gray-300 ml-2'>ashish@gamil.com</span>
            </h1>
          </div>
      ...
      <div>
        ...
        <div className='gird grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-5'>
          {
